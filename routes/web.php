...
Route::get('/message-center', [HomeController::class, 'messageCenter'])->middleware('dashboard.admin')->name('message-center.index');
Route::get('/user-management', [HomeController::class, 'userManagement'])->middleware('dashboard.admin')->name('users.index');
